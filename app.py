            ...
            if st.button("🚀 Procesar Lote General", use_container_width=True, type="primary"):
                ...
                try:
                    ...
                    if count_nuevos > 0:
                        ...
                        st.error(f"🚨 **ATENCIÓN - SE DETECTARON {count_nuevos} PERSONAS NUEVAS**\n\nLos soportes contables se generaron de forma independiente y también se compiló el listado para el señor José. Utiliza los botones para descargar la información:")
...
with tab_informes:
    ...
    if cortes_disponibles:
        ...
        c1.metric("Total Cuentas de Cobro", total_cuentas)
        c2.metric("Cuentas Pagadas ($0)", cuentas_cero)
        c3.metric("Cuentas por Pagar", total_cuentas - cuentas_cero)
